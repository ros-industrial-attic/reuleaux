...
public:
 ...
 virtual ~ReachMapVisual();
  void setMessage( const map_creator::WorkSpace::ConstPtr& msg, bool do_display_arrow, bool do_display_sphere,  int low_ri, int high_ri, int shape_choice, int disect_choice);
