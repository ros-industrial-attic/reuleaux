...
SphereViz::SphereViz(){
    marker_pub=nh_.advertise<visualization_msgs::MarkerArray>("grasp_poses",1);
    point_pos=nh_.subscribe<geometry_msgs::PoseArray>("orientations2",1,&SphereViz::PointCallback, this);
}
...
{
    ros::init(argc, argv, "grasp_arrows");
    ros::NodeHandle n;
    ros::Rate r(1);
