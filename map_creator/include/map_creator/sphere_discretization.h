...
public:
    ...
    //! Defines if a point belongs to a pointcloud. First crates a hull of the poincloud and computes Area, then adds the point to the pointcloud and again computes new Area. If the New Area is bigger than the previous area, the point is outside poincloud, otherwise inside
