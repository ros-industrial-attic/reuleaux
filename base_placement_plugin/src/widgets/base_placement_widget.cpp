...
namespace base_placement_plugin
{
	namespace widgets {
		...
		BasePlacementWidget::BasePlacementWidget(std::string ns):
		param_ns_(ns)
		{
    ...
    void BasePlacementWidget::loadReachabilityFile()
{
	...
	*/
	QString fileName = QFileDialog::getOpenFileName(this, tr("Open Inverse Reachability File"), "",	tr("Reachability (*.h5);;All Files (*)"));
